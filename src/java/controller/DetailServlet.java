...
public class DetailServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        CommentDAO daocm = new CommentDAO();
        SizeDAO daos=new SizeDAO();
        List<Comment> listcm = daocm.getCommentByPid(pId);
        List<Size> listS=daos.getSize();
        List<Categories> list = daoC.getAllCategories();
        Products p=daoP.getProductsByPID(pId);
        if(a!=null){
